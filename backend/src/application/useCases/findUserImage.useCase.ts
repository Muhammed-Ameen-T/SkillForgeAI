...
export class FindUserImagesUseCase implements IFindUserImagesUseCase {
   ...
   */
  constructor(@inject(TYPES.ImageRepository) private _imageRepository: IImageRepository) {}
  ...
  async execute(params: {
    ...
    try {
      ...
      throw new CustomError(ErrorMsg.IMAGE_NOT_FOUND, HttpResCode.INTERNAL_SERVER_ERROR)
    }
  }
}